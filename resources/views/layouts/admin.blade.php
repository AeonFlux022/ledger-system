...
<body class="flex min-h-screen bg-gray-100">
  ...
  <aside class="fixed top-0 left-0 h-full w-64 bg-white shadow-md p-6 space-y-4 hidden md:block">
    ...
    <nav class="space-y-2">
      ...
      <a href="/admin/payments" class="block px-4 py-2 rounded hover:bg-blue-100 text-gray-700">Payments</a>
      <a href="/admin/sms-logs" class="block px-4 py-2 rounded hover:bg-blue-100 text-gray-700">SMS Logs</a>
